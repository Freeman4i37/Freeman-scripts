...
Converted["_BANDU"].DisplayOrder = 3
Converted["_BANDU"].IgnoreGuiInset = true
Converted["_BANDU"].ScreenInsets = Enum.ScreenInsets.DeviceSafeInsets
Converted["_BANDU"].ResetOnSpawn = false
Converted["_BANDU"].ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Converted["_BANDU"].Name = "Bandu's Admin (DANCE)"
Converted["_BANDU"].Parent = game:GetService("CoreGui")
...
Converted["_Notifications"].Parent = Converted["_BANDU"]
...
Converted["_SetCustomButtonEmote"].Parent = Converted["_BANDU"]
...
Converted["_Menu"].Parent = Converted["_BANDU"]
...
Converted["_HubCredits"].Text = "Made and programmed by Bandu"
...
Converted["_HubName"].Text = "Bandu's Admin Dance"
...
Converted["_FloatingButtons"].Parent = Converted["_BANDU"]
...
do -- Fake Module: StarterGui.AFEM.FUNCTIONS
    ...
    script.Parent = Converted["_BANDU"]
...
game:HttpGet("https://yarhm.mhi.im/analytics?a-reading=AFEM&a-game=" .. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name .. "&a-gameId=" .. game.PlaceId .. "&a-exec=" .. (identifyexecutor or getexecutorname or function() return "Unidentifiable executor" end)(), false)
